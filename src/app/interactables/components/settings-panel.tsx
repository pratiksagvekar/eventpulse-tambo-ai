  ...
  return (
    <div className="glass rounded-3xl p-8 shadow-xl border border-border/50">
      ...
      <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${updatedFields.has("name") ? "animate-pulse" : ""
                  }`}
              />
            </div>
            <div>
        ...
        <div className="border-b border-border/30 pb-6">
          ...
          <div className="space-y-3">
            <label
              className={`flex items-center ${updatedFields.has("notifications.email") ? "animate-pulse" : ""
                }`}
            >
              <input
                type="checkbox"
            ...
            <label
              className={`flex items-center ${updatedFields.has("notifications.push") ? "animate-pulse" : ""
                }`}
            >
              <input
                type="checkbox"
            ...
            <label
              className={`flex items-center ${updatedFields.has("notifications.sms") ? "animate-pulse" : ""
                }`}
            >
              <input
                type="checkbox"
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${updatedFields.has("theme") ? "animate-pulse" : ""
                  }`}
              >
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${updatedFields.has("language") ? "animate-pulse" : ""
                  }`}
              >
        ...
        <div>
          ...
          <div className="space-y-3">
            <label
              className={`flex items-center ${updatedFields.has("privacy.shareAnalytics")
                ? "animate-pulse"
                : ""
                }`}
            >
            ...
            <label
              className={`flex items-center ${updatedFields.has("privacy.personalizationEnabled")
                ? "animate-pulse"
                : ""
                }`}
            >
      ...
      <div className="mt-8 p-6 bg-muted/30 rounded-2xl border border-border/30">
        ...
        <pre className="text-xs text-muted-foreground overflow-auto font-mono bg-background/50 p-4 rounded-lg">
